...
if(isset($_POST['edit'])){
    ...
    authtele='$authtele', authsite='$authsite', statuz='Approved'
    WHERE id = '$id'";
...
if(isset($_POST['submit'])){
    ...
    if (empty($fname)) {
        ...
        usersign,sitee,authorizedby,authsign,authposition,authtele,authsite,statuz) VALUES 
        ...
        '$usersign','$sitee','$authorizedby','$authsign','$authposition','$authtele','$authsite','Pending')";
