...
$_SESSION['aptid'] = $id;
$sql1 = "SELECT * FROM finaltable where id='$id' ";
...
<body>
    <div class="container">
        ...
        <form action="conedit.php" method="post">
            ...
            <div class="">
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Status</label>
                            <input type="text" id="statuss" name="statuss" value=<?php echo $row['statuss']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Position title</label>
                            <input type="text" id="ptitle" name="ptitle" value=<?php echo $row['ptitle']; ?> >
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="snumber" name="snumber" value=<?php echo $row['snumber']; ?> >
                        </div>
                    </div>
                </div>
                ...
                <div class="details ID">
                    ...
                    <div class="input-field">
                            ...
                            <input type="text" id="extensionn" name="extensionn" value=<?php echo $row['extensionn']; ?> >
                        </div>
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="supervisorr" name="supervisorr" value=<?php echo $row['supervisorr']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Account Expiry Date</label>
                            <input type="date" id="expirydate" name="expirydate" value=<?php echo $row['expirydate']; ?> >
                        </div>
                    </div>
            ...
            <div class="">
                <div class="details personal">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" id="pdrivedep" name="pdrivedep" value=<?php echo $row['pdrivedep']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Level of Access of P:\Drive</label>
                            <input type="text" id="pdrivelevel" name="pdrivelevel" value=<?php echo $row['pdrivelevel']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Corporate Email Address</label>
                            <input type="text" id="coremail" name="coremail" value=<?php echo $row['coremail']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Home Internet Access</label>
                            <input type="text" id="homenet" name="homenet" value=<?php echo $row['homenet']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Internet Access</label>
                            <input type="text" id="internetaccess" name="internetaccess" value=<?php echo $row['internetaccess']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Justification</label>
                            <input type="text" id="accjust" name="accjust" value=<?php echo $row['accjust']; ?> >
                        </div>
                    </div>
                </div>
                ...
                <div class="details ID">
                    ...
                    <div class="input-field">
                            ...
                            <input type="text" id="prontoaccess" name="prontoaccess" value=<?php echo $row['prontoaccess']; ?> >
                        </div>
                ...
                <div class="details address">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" id="accre" name="accre" value=<?php echo $row['accre']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Account Payable Level</label>
                            <input type="text" id="accpa" name="accpa" value=<?php echo $row['accpa']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Genral Ledge Level</label>
                            <input type="text" id="genled" name="genled"  value=<?php echo $row['genled']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Fixed Assets Level</label>
                            <input type="text" id="fixedass" name="fixedass" value=<?php echo $row['fixedass']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Purchasing Level</label>
                            <input type="text" id="purchaselevel" name="purchaselevel" value=<?php echo $row['purchaselevel']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Inventory Level</label>
                            <input type="text" id="inventlevel" name="inventlevel" value=<?php echo $row['inventlevel']; ?> >
                        </div>
                    </div>
                </div>
                ...
                <div class="details family">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" id="mainlevel" name="mainlevel" value=<?php echo $row['mainlevel']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Project Level</label>
                            <input type="text" id="prolevel" name="prolevel" value=<?php echo $row['prolevel']; ?> >
                        </div>

                        <div class="input-field">
                            <label>System Administration</label>
                            <input type="text" id="sysadmin" name="sysadmin" value=<?php echo $row['sysadmin']; ?> >
                        </div>
                    </div>
                    ...
                    <div class="">
                        <div class="details address">
                            ...
                            <input type="text" id="dbaccess" name="dbaccess" value=<?php echo $row['dbaccess']; ?> >
                        </div>
        
                                <div class="input-field">
                                    <label>Justification</label>
                                    <input type="text" id="dbjus" name="dbjus" value=<?php echo $row['dbjus']; ?> >
                                </div>
        
                                <div class="input-field">
                                    <label>Databases Required</label>
                                    <input type="text" id="dbreq" name="dbreq" value=<?php echo $row['dbreq']; ?> >
                                </div>
                            </div>
                    ...
                    <div class="details address">
                        ...
                        <div class="fields">
                            <div class="input-field">
                                ...
                                <input type="text" id="usersign" name="usersign" value=<?php echo $row['usersign']; ?> >
                            </div>
    
                            <div class="input-field">
                                <label>Site</label>
                                <input type="text" id="sitee" name="sitee" value=<?php echo $row['sitee']; ?> >
                            </div>
    
                            <div class="input-field">
                                <label>Databases Required</label>
                                <input type="text" placeholder="Databases Required" >
                            </div>
                        </div>
            ...
            <div class="details personal">
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" id="proccessedby" name="proccessedby" value=<?php echo $row['proccessedby']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Date</label>
                            <input type="text" id="ittdate" name="ittdate" value=<?php echo $row['ittdate']; ?> >
                        </div>
                ...
                <div class="details ID">
                    ...
                    <div class="input-field">
                        ...
                        <div class="input-field">
                            <label>Processed By</label>
                            <input type="number" id="proproccessed" name="proproccessed" value=<?php echo $row['proproccessed']; ?> >
                        </div>

                        <div class="input-field">
                            <label>Date</label>
                            <input type="text" id="prontodate" name="prontodate" value=<?php echo $row['prontodate']; ?> >
                        </div>
